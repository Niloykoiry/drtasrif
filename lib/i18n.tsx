    ...
    items: [
      {
        ...
        full: "A visit to a leading teaching hospital in Dhaka, observing how multidisciplinary teams plan and deliver maxillofacial care — from diagnosis and surgical planning to recovery and follow-up.",
      },
      {
